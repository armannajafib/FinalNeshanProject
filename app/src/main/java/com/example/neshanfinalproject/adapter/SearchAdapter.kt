...
class SearchAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        Log.i("SearchAdapter", "onCreateViewHolder: ")
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        override fun onClick(v: View) {
            ...
            val title = items[adapterPosition].title
            val address = items[adapterPosition].address

            onSearchItemListener.onSearchItemClick(LatLng,title)
        }
    ...
    interface OnSearchItemListener {
        fun onSearchItemClick(LatLng: LatLng?, title: String?)
    }
}